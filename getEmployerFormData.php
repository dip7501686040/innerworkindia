        ...
        $result = '<div id="recruitment">
                               ...
                               <div class="row">
                                   <div class="col-md-4">
                                       ...
                                       <input type="text" name="jobDescription" id="jobDescription" placeholder="Job Description" class="form-control" required>
                                   </div>
                                   <div class="col-md-4">
                                       <label for="mySkills">Key Skills</label>
                                       <input type="text" name="mySkills" id="mySkills" class="form-control" placeholder="Skills" required>
                                   </div>
                                   <div class="col-md-4">
                                       <label for="experiencedRequired">Experience Required</label>
                                       <input type="text" name="experiencedRequired" id="experiencedRequired" class="form-control" placeholder="Experience Required" required>
                                   </div>
                               </div>
                               <div class="row">
                                   <div class="col-md-4">
        ...
        $result = '<div id="staffing">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="keySkills" id="keySkills" class="form-control" placeholder="Skills" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="experienceRequired">Experience Required</label>
                                        <input type="text" name="experienceRequired" id="experienceRequired" class="form-control" placeholder="Experience Required" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="educationRequired">Education Required</label>
                                        <input type="text" name="educationRequired" id="educationRequired" class="form-control" placeholder="Education Required" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="currentSalary">Current Salary</label>
                                        <input type="text" name="currentSalary" id="currentSalary" class="form-control" placeholder="Salary" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="expectedSalary">Expected Salary</label>
                                        <input type="text" name="expectedSalary" id="expectedSalary" class="form-control" placeholder="Expected Salary" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="noticePeriod">Notice Period</label>
                                        <input type="text" name="noticePeriod" id="noticePeriod" class="form-control" placeholder="Notice Period" required>
                                    </div>
                                    <div class="col-md-4">
