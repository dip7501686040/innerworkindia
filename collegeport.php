...
<?php include_once 'Header.php'; ?>
                ...
                <div id="oneD">
                   ...
                   <div id="candidateFormResult"></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="collegename" class="form-control" required="required" placeholder="Enter Your College Name" id="field">
                            </div>
                            <div class="col-md-6">
                                  <label for="university" style="color:#000;">University Name</label>
                                  <input type="text" name="university" id="field" class="form-control" required="required" placeholder="Enter Your University Name">
                            </div>
                            </div>
                           <div class="row form-group">
                            <div class="col-md-6">
                                <label for="city" style="color:#000;">City</label>
                                <input type="text" name="city" class="form-control" required="required" id="field" placeholder="Enter Your City Name" >
                            </div>
                            <div class="col-md-6">
                                <label for="email" style="color:#000;">E-mail</label>
                                <input type="email" name="email" class="form-control" required="required" id="field" placeholder="Enter Your Email">
                            </div>
                            </div>
                            <div class="row form-group">
                            <div class="col-md-6">
                            <label for="looking" style="color:#000;">Looking for:</label>
                            <select class="form-control" name="looking" required="required" placeholder="Looking for..." id="field">
                                <option value=""></option>
                                <option></option>
                                ...
                                <input type="text" name="website" class="form-control" required="required" placeholder="Your College Website" id="field">
                            </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <label for="dept" style="color:#000;">Department</label>
                                        <select class="form-control" name="dept" required="required" id="field" placeholder="Department Name" >
                                            <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="numofstudent" id="field" class="form-control" required="required" placeholder="Number of Students">
                                    </div></div>
				<div class="row form-group">
					<div class="col-md-6">
						<label for="Contact " style="color:#000;">Contact Number</label>
						 <input type="text" name="phone" pattern="[0-9]{10}" maxlength="10" id="field" class="form-control" required="required" placeholder="Contact Number">
                                    	</div>
					<div class="col-md-6">
                                    		<label for="Contact Person Name " style="color:#000;">Contact Person Name</label>
                                    		<input type="text" name="contactperson"  id="field"placeholder="Contact Person Name" class="form-control" placeholder="Contact Person Name" required="required">
                                  	</div>
				</div>
                                  <div class="row form-group">
                                      <div class="col-md-6">
                                        <label for="aboutcollege" style="color:#000;">About the college!</label>
                                        <textarea name="aboutcollege" id="field" class="form-control" required="required" placeholder="Write about your College.." rows="6" cols="50"></textarea>
                                        </div>
                                      <div class="col-md-6">
                                        <label for="writeuscollege" style="color:#000;">Write Us!</label>
                                        <textarea name="writeuscollege" id="field" class="form-control" required="required" placeholder="Write Us!" rows="6" cols="50"></textarea>
                                    </div>
    ...
    <section id="about">
      <div class="col-md-6 full">
          <img src="Images/HR sevices - Trainging an ddevelopmentAsset 18.jpg" alt="">
      </div>
    <div class="container">
