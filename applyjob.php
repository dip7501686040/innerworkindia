            ...
            if ($_POST['city'] != null && !empty($_POST['city'])) {
                ...
                $typee=$_POST['typee'];
                  ...
                  // $adminEmail = 'info@innerworkindia.com';
                                      ...
                                      $stmt = $conn->prepare('insert into internship (name, email, gender, city, education, mobno, exp, skill, interest, fnamee, jobpost_id) VALUES(?,?,?,?,?,?,?,?,?,?,?)');
                                        $stmt->bindParam(1, $name);
        ...
        <div class="row formDetail">
            ...
            <hr>
                         <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" required="required" placeholder="Enter Your Name" id="field"> <!-- pattern="[0-9]{10}" -->
                            </div>
                            <div class="col-md-6">
                                <label for="email" style="color:#000;">Enter Your Email Address</label>
                                <input type="email" name="email" class="form-control" required="required" id="field" placeholder="Enter YourEmail Address">
                            </div>
              ...
              <div class="row form-group">
                             <div class="col-md-6">
                                ...
                                <input type="text" name="mobno" class="form-control" required="required" id="field" placeholder="Enter Your Mobile Number">
                            </div>
                         <div class="col-md-6">
                                <label for="education" style="color:#000;">Qualification</label>
                                <input type="text" name="education" class="form-control" required="required" id="field" placeholder="Enter Your Highest Qualification" >
                            </div>
                        </div>
                       <hr>
             ...
             <div class="row form-group">
                            <div id="myDIV" class="col-md-12">
                                ...
                                <input type="text" name="skill" class="form-control" id="myInput" placeholder="Enter Your Skills" onkeyup="showResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
            ...
            <div class="row form-group">
                            <div id="uDIV" class="col-md-12">
                                ...
                                <input type="text" name="interest" class="form-control" id="uInput" placeholder="Enter Your Interest" onkeyup="showinterestResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
...
function sendmail(){
             $name = $_POST['name'];
                ...
                $email= $_POST['email'];
             $mail = new PHPMailer();
            $body = "Dear ".$name."," . "<br/>" . "Welcome to Innerwork and thanks for Submit your details our admin will contact you soon.<br>";
