...
<section id="banner">
    <div class="container">
        ...
        <form action="loginpage.php" method="post">
             ...
             <input id="place" class="enterinfo" type="email" name="email" placeholder="Enter your Email" required="" style="padding-left:53px;">
             <span class="focus-input100"></span>
             <span class="symbol-input100">
             <i class="fa fa-user"></i></span>
        </div>
        <div class="wrap-input100 validate-input">
             <input  class="enterinfo" type="password" name="password" placeholder="Enter your Password" required="">
             <span class="focus-input100"></span>
             <span class="symbol-input100">
