...
.line-break {
    display:block;
      ...
      .drop{background: #d3d3d380;padding: 3%;height: 460px;}
      .drop p{}
      ...
      ul.socialContact{list-style-type: none;margin-left: -19%;}
      ul.socialContact li{float: left;margin-left: 10%; margin-right: -2%}
...
@media (max-width: 480px) {
    .form input[type="submit"] {display: block;width: 36%;}
    #contact h4 {margin-top: 0;}
    .drop {height: 280px;}
    ul.socialContact li{float: left;margin-left: 5%; margin-right: -2%}

}
@media (max-width:350px){
    .drop{background: #d3d3d380;padding: 3%;height: 380px;}
     ul.socialContact li{float: left;margin-left: 5%; margin-right: -2%}
}
    ...
    <div class="container">
                ...
                <div class="row form">
                    <div class="col-md-12">
                        ...
                        <form action="<?=($_SERVER['PHP_SELF'])?>" method="post">
                            ...
                            <textarea name="msg" placeholder="Your Message" class="form-control" rows="4" required></textarea>
                            <input type="submit" value="Submit Now" name="submit" class="form-control" style="margin-bottom: 2%;" /><br>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4 drop">
            ...
            <div class="address">
                ...
                <p><i class="fa fa-phone"></i> <span>9887888469</span></p>
            </div>
            <h4>Follow Us</h4>
...
<div class="container">
    <div style="margin-top: 30px !important;">
        ...
        <span class="line-break"><i class="fa fa-phone" aria-hidden="true">&nbsp;</i>  7064583991</span>
        ...
        <p><span class="line-break">B-171/172, first floor, Nehru Vihar, Delhi - 110054 (India)</span>
        <span class="line-break"> <i class="fa fa-phone" aria-hidden="true">&nbsp;</i>  8287814900</span>
        <span class="line-break"><i class="fa fa-envelope-o" aria-hidden="true">&nbsp;</i> <a href="mailto:info@innerworkindia.com">info@innerworkindia.com</a></span></p>
              </div>
        </div>
        <div class="col-md-4 col-xs-12" style="padding-bottom:10px;">
        ...
        <p><span class="line-break">284, Geetratna, Virar(west), Palghar, Mumbai, Maharashtra - 400054 (India)</span>
        <span class="line-break"><i class="fa fa-phone" aria-hidden="true">&nbsp;</i>  9356625986</span>
        <span class="line-break"><i class="fa fa-envelope-o" aria-hidden="true">&nbsp;</i> <a href="mailto:info@innerworkindia.com">info@innerworkindia.com</a></span></p>
                </div>
        </div>
        </div>
