 ...
 ";
        ...
        <ul class="list-group" style="paddding-left:6% !important;">
          <a href="#" id="tp"><li class="list-group-item" title="' .$row['type'] .'" data-etracking="true" onclick="javascript:fillIntype(this.innerHTML);" style="cursor:pointer;"><i class="fa fa-briefcase"></i>&nbsp;' .$row['type'] .'
           ...
           <a href="#"><li class="list-group-item" title="Compensation" data-etracking="true" data-ecategory="job_card_compensation" onclick="javascript:fillInsalary(this.innerHTML);" style="cursor:pointer;">
        <i class="fa fa-inr" ></i>' .$row['maxSalary'] .'
          </li></a>
          <a href="#"><li class="list-group-item" title="Qualification" data-etracking="true" data-ecategory="job_card_start_date" onclick="javascript:fillInedu(this.innerHTML);" style="cursor:pointer;">
       ...
       $query = $conn->prepare($qry);
        ...
        foreach($data as $row) {
			...
			<div class="job-title">
                ...
                <div class="row job-info no-margin-left no-margin-right" style="margin-left:1%;">
        <ul class="list-group" style="paddding-left:6% !important;">
        <a href="#"><li class="list-group-item" title="' .$row['type'] .'" data-etracking="true"><i class="fa fa-briefcase"></i>&nbsp;' .$row['type'] .'
           </li></a>
           <a href="#"><li class="list-group-item" title="Compensation" data-etracking="true" data-ecategory="job_card_compensation">
        <i class="fa fa-inr" ></i>' .$row['maxSalary'] .'
          </li></a>
          <a href="#"><li class="list-group-item" title="Qualification" data-etracking="true" data-ecategory="job_card_start_date">
            <i class="fa fa-user" ></i>' .$row['education'] .'
          </li></a>
          </ul></div>
         <div class="row no-margin-left no-margin-right job-lowest-section">
...
if(isset($_POST["fillcomp"])){
    $comp=$_POST["comp"];
 //   echo $loc;
 echo '<pre>'; print_r($_POST["comp"]); echo '</pre>';
    ...
    $qry="select * from jobpost where status=1 and location='$loc'";
       ...
       $query = $conn->prepare($qry);
        ...
        foreach($data as $row) {
			...
			<div class="nav nav-pills" style="width:100%;height:100%;background-color:#ffc114;padding-left: 1%">
			<div class="job-title">
                <b><h4 class="truncate-normal" title="'. $row['jobTitle'] .'" data-etracking="true"><a href="#" id="j_title" >'. $row['jobTitle'] .'</a></h4></b>
                </div></div>
                <div class="company-name"><p class="truncate-normal"style = "padding-left: 1%;" title="' .$row['company'] .'" data-etracking="true"><a href="#" target="_blank" >' .$row['company'] .'</a></p></div>
                <div class="job-locations"><p class="truncate-normal" style = "padding-left: 1%;" title="Location(s)" data-etracking="true"><a href="#" target="_blank" > '. $row['location'] .'</a></p></div>
                </div>
...
if(isset($_POST["fillsal"])){
    $sal=$_POST["sal"];
 //  echo $sal;
 echo '<pre>'; print_r($_POST["sal"]); echo '</pre>';
...
if(isset($_POST["filledu"])){
 //  echo $sal;
   //$edu = preg_replace('/\s+/','',$edu);
    $edu = trim($_POST["edu"]);
    echo '<pre><b>'; print_r($edu); echo '</b></pre>';

    $qry="select * from jobpost where status=1 and education='$edu'";
