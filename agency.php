	      ...
	      <div class="container-fluid">
		    ...
		    <div class="container-fluid mt--6">
		      <div class="row">
    			...
    			<div class="col-md-8  ">
    			  	<input type="file" name="myfile1" placeholder="My file 1" accept=".pdf,.docx" required="required"></br>
    			</div>
    		</div>
    		</br>
    		<div class="row">
            ...
            <input type=file  name="myfile2" accept=".pdf,.docx" placeholder="My file 2" required> </br>
    			</div>
    		</div>
    		</br>
    		<div class="row">
    			...
    			<div class="col-md-8">
    			  	<input type="file" name="myfile3" accept=".pdf,.docx" placeholder="My file 3" required="required">  </br>
    			</div>
    		</div>
        <div class="row">
          <div class="col-md-4 ">
