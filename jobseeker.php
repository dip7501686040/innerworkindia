...
@media only screen and (max-width: 521px){
  .full{margin-left:-30px;margin-right:-30px;padding-left:0px !important;padding-right:0px !important;}
}
#drop_file_zone {
                    ...
                    if ($_POST['email'] != null && !empty($_POST['email'])) {
                        if ($_POST['mobno'] != null && !empty($_POST['mobno']) && (strlen(($_POST['mobno'])) == 10)) {
                            ...
                            try {
                              ...
                              $mailSendToAdminJobSeeker = $utils->adminMailToJobSeeker1($mail, $name, $contactNumber, $email, $city, $education,$skill,$interest, $exp, $imageName);
        ...
        <div class="row formDetail">
            ...
            <div class="col-md-12">
                    ...
                    <form action="<?=($_SERVER['PHP_SELF'])?>" method="post" class="formJob" style="border: 2px solid #999;padding: 2%;width:90%;margin-left: 5%;" enctype="multipart/form-data">
						...
						<hr>
                         <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" required="required" id="field" placeholder="Your Name"> <!-- pattern="[0-9]{10}" -->
                            </div>
                            <div class="col-md-6">
                                <label for="email" style="color:#000;">Enter Your Email Address</label>
                                <input type="email" name="email" class="form-control" required="required" id="field" placeholder="Your email">
                            </div>
                        ...
                        <div class="row form-group">
                              <div class="col-md-6">
                                ...
                                <select name="gender" class="form-control" required="required" id="field" placeholder="Your Gender">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="city" class="form-control" required="required" id="field" placeholder="Your City">
                            </div>
							</div>
							<div class="row form-group">
                             <div class="col-md-6">
                              ...
                              <input type="text" name="mobno" class="form-control" pattern="{0-9}[10]" maxlength="10" required="required" id="field" placeholder="Your Mobile Number" >
                            </div>
                         <div class="col-md-6">
                             ...
                             <select class="form-control" required="required" id="field" name="education" placeholder="Your Education" >
					   ...
					   <hr>
						 ...
						 <div class="row form-group">
						  <div class="col-md-12">
                            ...
                            <select class="form-control"  name="exp" required="required" id="field" placeholder="Your Experience" >
                <option value="">Select</option>
                ...
                <option>Others</option>
					     ...
					     <input type="text" name="skill" class="form-control" id="myInput" placeholder="Your Skills" onclick="newElement()" onkeyup="showResult(this.value)" style="margin:0;border:none;border-radius:0;width:100%;  padding: 10px;float: left;font-size: 16px;">
				    ...
				    <input type="text" name="interest" class="form-control" onclick="newElement1()" id="uInput" placeholder="Your Interest" onkeyup="showinterestResult(this.value)" style="margin:0;border:none;border-radius:0;width:100%;  padding: 10px;float: left;font-size: 16px;">
<!--                                 <input type="text" name="interest" class="form-control" id="uInput" onkeyup="showinterestResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
  ...
  <div id="drag_upload_file">
    <p>Drop file here</p>
    <p>or</p>
    <p><input type="button" value="Select File" class="center" onclick="file_explorer();" style="width: fit-content !important;"></p>
...
<div id="showresult" class="row form-group" style="margin-bottom:3%;"></div>
                        ...
                        <input type="submit" value="Submit" name="submit" class="form-control" placeholder="Submit" style="margin-top:3%;"/>
                    </form>
...
<img src="Images/JoB internship page internship imageAsset 23.jpg" class="style" alt="">
  </div>
