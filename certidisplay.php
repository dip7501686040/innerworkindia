...
<div id ="certificate" class="certificate">
		<div id="background">
            ...
            <div id="body">
                ...
                <div id="ref">Ref:INWRK/INT/2020/2025</div>
                ...
                <div id="details">This is to certify that Mr. &nbsp<b><?php echo $firstname;?>&nbsp<?php echo $lastname;?></b>, S/O &nbsp<b><?php echo $f_name;?></b>, a student of &nbsp <b><?php echo $degree;?></b> &nbsp(Branch-<?php echo $branch;?>),<b><?php echo ' ';echo $college_name; echo ' '; echo ','; echo ' '; echo $college_address;  ?></b> has successfully completed <?php echo $work_duration; ?> &nbsp(From <?php echo $JoinDate; echo ' '; echo 'to'; echo ' ';  echo $ResignDate;  ?>) internship program as a <b> <?php echo $designation;?></b> at <b> Innerwork Solution Pvt Ltd,</b> Bangalore. During the period of his internship program with us he was found punctual , hardworking and inquisitive.<br><b>Project Details: &nbsp</b><?php echo $projectDetail; ?><br><br> We wish him very success in life<br><br>For &nbsp<b>Innerwork Solution Pvt Ltd.</b><br> Sheela <br> HR Manager  </div>
            </div>
...
<?php
        ...
        ?>
    <script>
        alert("Sorry! You cannot download certificate NOW");
        </script>
        <?php
    }
?>
