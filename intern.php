...
<section id="jobApplication">
                    ...
                    <form action="<?=($_SERVER['PHP_SELF'])?>" method="post" class="formJob" enctype="multipart/form-data" style="border: 2px solid #999;padding: 2%;width:90%;margin-left: 5%;">
                        <div id="candidateFormResult"></div>
                         <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" required="required" id="field" placeholder="Name" > <!-- pattern="[0-9]{10}" -->
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row form-group">
                              <div class="col-md-6">
                                ...
                                <select name="gender" class="form-control" required="required" id="field" placeholder="Gender">
                                    <option  value=""></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="city" class="form-control" required="required" id="field" placeholder="City" >
                            </div></div>
                            <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" required="required" id="field" name="education" placeholder="Education" >
                           ...
                           <!--     <input type="text" name="mobno" class="form-control" required="required" id="field" >-->
                                    <input type="text" name="mobno" class="form-control" placeholder="Mobile Number" pattern="{0-9}[10]" maxlength="10" required="required" id="field" >

                            </div></div>
                             <div class="row form-group">
                            <div class="col-md-6">
                                <label for="experience" style="color:#000;">Duration</label>
                            <select class="form-control"  name="exp" required="required" id="field" placeholder="Experience" >
                <option value=""></option>
				<option></option>
                ...
                <option>6 months</option>
						 ...
						 <div class="row form-group">
                            <div id="myDIV" class="col-md-12">
                                ...
                                <input type="text" name="skill" class="form-control" id="myInput" placeholder="Skills" onkeyup="showResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
                         ...
                         <div class="row form-group">
                            <div class="col-md-12">
                                <label for="mobno" style="color:#000;">Interest</label>
                                            <input type="text" name="interest" class="form-control" id="uInput" placeholder="Interest" onkeyup="showinterestResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
  ...
  <div id="drag_upload_file">
    <p>Drop file here</p>
    <p>or</p>
    <p><input type="button" value="Select File" class="center" onclick="file_explorer();" style="width:fit-content !important;" name="attach1"></p>
    <input type="file" id="selectfile">
	<input type="hidden" id="filename" name="fnamee" placeholder="File Name" >
  </div>
</div>
<div id="showresult" class="row form-group" style="margin-bottom:3%;"></div>
                        ...
                        <input type="submit" value="Submit" name="submit" placeholder="Submit" class="form-control" style="margin-top:3%;width:fit-content !important;"/>
                    </form>
                </div>
            </div>
        </div>
...
<section id="about">
  <div class="col-md-6 full">
      <img src="Images/JoB internship page internship imageAsset 23.jpg" alt="">
  </div>
    <div class="container">
        <div class="row">
