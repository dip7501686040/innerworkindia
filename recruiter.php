...
<link rel="stylesheet" href="css/demo.css">
    ...
    @media only screen and (max-width: 521px){
      .full{margin-left:-30px;margin-right:-30px;padding-left:0px !important;padding-right:0px !important;width:auto;}
    }
...
<<<<<<< HEAD
      #about{padding: 10px 10px;background: #ecf5f7;}
      
=======

>>>>>>> 2ba1bc4ef381a640254365ca9e5a787f12ba04fd
      .aboutContent .free{
        width: 100%;margin: 0px;padding: 0px;

      }
      .aboutContent .free #freeimg{
        width: 100%;
        margin: 0%;
      }
          ...
          <div class="wrap-login100 p-t-0 p-b-30" style="width: 800px">
            ...
            <form action="recruiterregistration.php" method="post" class="login100-form" enctype="multipart/form-data" onsubmit="return myfun()" id="detailsform">
               ...
               <div class="company_div col-md-12 validate-input m-b-10">
                   <input class="input100 company_name" type="text" style="font-family: 'Raleway';font-weight: bold;" name="companyname" placeholder="Enter Company Name" required="">
                   <span class="focus-input100"></span>
                   <span class="symbol-input100"><i class="fa fa-copyright"></i></span>
               </div>
               <div class="fullname_div col-md-12 validate-input m-b-10">
                  <input class="input100 full_name" type="text" value="" style="font-family: 'Raleway';font-weight: bold;" name="fullname" placeholder="Enter Full Name">
                  <span class="focus-input100"></span>
                  <span class="symbol-input100"><i class="fa fa-user"></i></span>
               </div>
               <div class="website_div col-md-12  validate-input m-b-10">
                   <input class="input100 " type="text" style="font-family: 'Raleway';font-weight: bold;" name="website" placeholder="Enter Website" required="" value="">
                   <span class="focus-input100"></span>
                   <span class="symbol-input100"><i class="fa fa-globe"></i></span>
               </div>
               <div class="col-md-12 validate-input m-b-10">
                    <input class="input100" type="text" style="font-family: 'Raleway';font-weight: bold;" name="mobile" placeholder="Enter Mobile Number" required="" value="" pattern="{0-9}[10]" maxlength="10">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100"><i class="fas fa-mobile-alt"></i></span>
               </div>
               <div class="col-md-12 validate-input m-b-10">
                    <input class="company_address input100" type="text" style="font-family: 'Raleway';font-weight: bold;" name="address" placeholder="Enter Company Address" required="" value="">
                    <span class="focus-input100"></span>
               ...
               <div class="col-md-12 validate-input m-b-10">
                   <select id="state" name="city" style="height:50px;font-family: 'Raleway';font-weight: bold;border-radius:50px;padding-left:6%;" class="form-control input100" placeholder="Enter City" required=""></select>
                   <span class="focus-input100"></span>
                   <span class="symbol-input100"><i class="fas fa-map-marked-alt"></i></span>
               </div>
               <div class="col-md-12 validate-input m-b-10">
                   <input class="input100" type="text" style="font-family: 'Raleway';font-weight: bold;" name="postcode" placeholder="Post Code" placeholder="Enter Postal Code" required="" value="">
                   <span class="focus-input100"></span>
               ...
               <div class="col-md-12 validate-input m-b-10">
                     <input class="input100" type="email" value="" style="font-family: 'Raleway';font-weight: bold;padding-left:53px;margin-bottom:0%;" name="email" placeholder="Enter Email Address" required="" id="email">
                     <span class="focus-input100"></span>
                     <span class="symbol-input100"><i class="fa fa-user"></i></span>
               </div>
               <div class="col-md-12 validate-input m-b-10">
              ...
              <div class="image_div col-md-12 validate-input m-b-10">
               ...
               <div id="drop_file_zone" ondrop="upload_file(event)" ondragover="return false" style="height: 40px;">
                    <div id="drag_upload_file" style="height: 50px;">
                      <p><abbr title="Click here to choose image" style="border: none;"><input type="button" name="tooltip" value="Select Image" onclick="file_explorer();" style="width: 100%;border-radius: 50%;height: 40px;padding-bottom: 1px;font-weight: bold;background: white;" required=""></abbr></p>

                      <input type="file" / id="selectfile" style="height: 20px;">
                       <input type="hidden" id="filename" name="fnamee" style="height: 20px;">
...
<section id="about">
  <div class="col-md-6 free full">
      <img class="img-fluid" src="Images/Freelancer page - freelance Asset 4.jpg" alt="" id="freeimg" style="width: 100%;padding: 0%;margin: 0%;">
  </div>
