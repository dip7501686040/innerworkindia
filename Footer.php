    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-xs-12">
                ...
                <p style="color: white">Innerwork is emerging as a leader in the next phase of HR Services</p>
            ...
            <div class="col-md-4 col-xs-12">
                <div class="contactDetail" style="color:#01131b;">
                    ...
                    <p><i class="fa fa-phone"></i><span><a href="tel:(080)-4209-2269)"> (080)-4209-2269)</href></span></p>
                     <p><i class=""></i><span><a href="tel:9887888469">&nbsp&nbsp&nbsp&nbsp9887888469</href></span></p>
...
">
    ...
    margin-bottom: 0;">
              <div class="input-group-append" style="margin-left: -1px;display: flex;">
                <span class="input-group-text"><button type="submit" name="button" placeholder="Submit" onclick="results()"><i class="fas fa-paper-plane paper"></i></button> <button type="button" onclick="closeForm()"><i class="fas fa-power-off"></i></button></span>
              </div>
            </div>
      </div>
    </div>
