...
@keyframes fadeInUp {
  ...
  to {
    ...
    .imgc{width:50px;height:50px;}
        @media (max-width: 480px) {
            .col-md-4{margin-left:5%;}
        }
        .cardshadow:hover{
    ...
    <div class="row wow">
                    <div class=" col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                            <div class="thumb">
                                <a href="https://set.jainuniversity.ac.in/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                    ...
                    <div class="col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                            <div class="thumb">
                                <a href="http://sabsngo.org/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                                        <h2>SABS</h2>
                    ...
                    <div class="col-md-3 col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.8s">
                            <div class="thumb">
                                <a href="https://www.jklu.edu.in/faculty/devendra-bhavsar/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                    ...
                    <div class="col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.9s">
                            <div class="thumb">
                                <a href="http://qspiders.com/anjali-m" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                                        <h2>Anjali</h2>
                    ...
                    <div class="col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.9s">
                            <div class="thumb">
                                <a href="https://www.bseindia.com/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                                        <h2>BSE</h2>
                    ...
                    <div class="col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.9s">
                            <div class="thumb">
                                <a href="https://www.upes.ac.in/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                                        <h2>UPES</h2>
                    ...
                    <div class="col-md-3  col-xs-6 y" >
                        <div class="item wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1s">
                            <div class="thumb">
                                <a href="https://uptownie.com/" target = "_blank" data-lightbox="image-1"><div class="hover-effect">
                                    <div class="hover-content">
                                        <h2>Uptownie</h2>
