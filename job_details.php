...
data-action="share/whatsapp/share"  target= "_blank"><img src="img/wp.jpg" style="height :30px"><p style="display: inline;color:black;font-size: 14px;">  Whatsapp</p></a>
        <a class="dropdown-item" style = "background-color: #fff;border-color:#fff;" href="http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Finnerworkindia.com%2Fjob_details.php%3Fid%3D<?php echo $jid; ?>" target= "_blank"><img src="img/link.png" style="height :30px"><p style="display: inline;color:black;font-size: 14px;">  Linkedin</p></a>
        </div>
													</div>
