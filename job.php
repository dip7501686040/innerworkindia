                    ...
                    <form action="<?=($_SERVER['PHP_SELF'])?>" method="post" id="jobp" enctype="multipart/form-data">
                       <div id="employerFormSubmitResult"></div>
                           <p><b style="color:red;">*</b>Details</p>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="company" placeholder="Company Name" value="<?php echo $_SESSION['companyname']; ?>" id="input-first-name" class="form-control" required="required">
                                    </div>
                                  </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label class="form-control-label" for="jobTitle">Job Title</label>
                                        <input type="text" name="jobTitle" id="input-title" class="form-control" required="required" placeholder="Job Title">
                                    </div>
                                </div>
                              </div>
                                    <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="email" value=" <?php echo $_SESSION['email']; ?>" name="email" id="input-email" class="form-control" required="required" placeholder="Email">
                                    </div>
                                  </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        <label class="form-control-label" for="jobType" >Job Type</label>
                                        <select name="jobType" class="form-control" required="required" id="input-type" placeholder="Job Type" >
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" name="location" id="input-city" class="form-control" required="required" placeholder="Location" >
                                    </div>
                                  </div>
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" id="input-sal" name="minSalary" id="minSalary" placeholder="Minimum Salary" ₹ Minimum" class="form-control" required="required">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" id="input-sal" name="maxSalary" id="maxSalary" placeholder="Maximum Salary" ₹ Maximum" class="form-control" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <input type="text" value=" <?php echo $_SESSION['contactperson']; ?>" name="cpname" id="input-name" placeholder="Contact Person Name" class="form-control" required="required">
                                    </div>
                                  </div>
                                   <div class="col-lg-6">
                                     <div class="form-group">
                                        <label for="cpnum" class="form-control-label" >Contact Person Number</label>
                                        <input type="text" value=" <?php echo $_SESSION['mobile']; ?>" name="cpnum" id="input-mobile" class="form-control" placeholder="Contact Person Number" required="required" pattern="{0-9}[10]" maxlength="10">
                                    </div></div>
                                  </div>
                                     <div class="row">
                                    ...
                                    <div class="col-lg-6"  >
                                      <div class="form-group">
                                        ...
                                        <select class="form-control"  name="education" required="required" id="input-education" placeholder="Education" >
                                            <option value=""></option>
                            ...
                            <select class="form-control"  name="exp" required="required" id="input-exp" placeholder="Experience" >
                                <option value=""></option>
                                ...
                                <option>Others</option>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                        ...
                                        <textarea name="j_desc" id="input-company" class="form-control" required="required" placeholder="Job Description" rows="6" cols="50"> 1) &#10; 2) &#10; 3) &#10; 4)</textarea>
                                        </div>
                                      </div>
                                ...
                                <div class="col-lg-6">
                                  <div class="form-group">
                                        ...
                                        <textarea name="about_comp" id="input-desc" class="form-control" required="required" placeholder="About Company" rows="6" cols="50"></textarea>
                                      </div></div></div>
                                      <div class="row ">
                                        <div class="col-lg-6">
                                          <div class="form-group">
                                                        <!-- <label for="skill" class="form-control-label">Skills</label>-->
                                                         <input type="text" placeholder="Skills" name="skill" class="form-control" id="myInput" placeholder="Skills" onkeyup="showResult(this.value)" style="margin:0;  padding: 10px;float: left;font-size: 16px;">
...
<center>
                            <input type="submit" onclick="return submitEmployerForm()" value="Submit" name="submit1" placeholder="Sbmit" class="btn btn-info" style="margin-top: 3%;"/>
                          </center>  </form>
                            ...
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input type="text" value=" <?php echo $_SESSION['companyname']; ?>" name="company" class="form-control" placeholder="Company" required="required" id="input-first-name">
                            </div>
                          </div>
                            <div class="col-lg-6">
                              <div class="form-group">
                                  <label for="jobTitle" class="form-control-label" >Internship Title</label>
                                  <input type="text" name="intTitle" id="input-title" class="form-control" required="required" placeholder="Internship Title">
                            </div>
                            </div>
                          </div>
                           <div class="row">
                            ...
                            <select class="form-control" name="exp" required="required" id="input-exp" placeholder="Duration">
                                <option value=""></option>
                                <option></option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="email" value=" <?php echo $_SESSION['email']; ?>" name="email" class="form-control" placeholder="Email" required="required" id="input-email">
                            </div></div></div>
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <textarea name="about_comp" id="input-company" class="form-control" placeholder="Company Description" required="required" rows="6" cols="50"></textarea>
                                      </div></div>
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label for="idesc" class="form-control-label">Internship Description</label>
                                        <textarea name="j_desc" id="input-desc" class="form-control" required="required" placeholder="Internship Description" rows="6" cols="50"> 1) &#10; 2) &#10; 3) &#10; 4)</textarea>
                                    </div>
                                  ...
                                  <div class="row ">
                                    <div class="col-lg-6">
                                      <div class="form-group">
                                                    <!-- <label for="skill" class="form-control-label">Skills</label>-->
                                                     <input type="text" placeholder="Skills" name="interest" class="form-control" id="uInput" placeholder="Interest" onkeyup="showinterestResult(this.value)" style="margin:0;  padding: 10px;float: left;font-size: 16px;">
...
<center>
                        <input type="submit" value="Submit" name="submit2" placeholder="Submit" class="btn btn-info" style="margin-top:3%;">
                  </center>  </form>
                        </div>
   ...
   $('.card').html('<div class="alert alert-danger alert-dismissable"><strong>Your Page is locked!</strong>Please upload your documents and wait for admin to activate your account.</div>');  <?php }  ?>
                      $("#job").click(function() {
                        $("#jobp").fadeIn();
                        $("#internp").fadeOut();
                      });
