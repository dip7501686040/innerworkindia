						      ...
						      <hr>
                                 <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="company" id="field" class="form-control" required="required" placeholder="Your Company">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="jobTitle" style="color:#000;">Job Title</label>
                                        <input type="text" name="jobTitle" id="field" class="form-control" required="required" placeholder="Your jobTitle">
                                    </div>
                                </div>
                                    <div class="row form-group">
                                    <div class="col-md-6">
                                        <label for="email" style="color:#000;">Email</label>
                                        <input type="email" name="email" id="field" class="form-control" required="required" placeholder="Your Email" >
                                    </div>
                                    <div class="col-md-6">
                                        <label for="jobType" style="color:#000;">Job Type</label>
                                        <select name="jobType" class="form-control" required="required" id="field" placeholder="Your jobType" >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="location" id="field" class="form-control" required="required" placeholder="Your Location">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="salary" style="color:#000;">Salary Range</label>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <input type="text" id="field" name="minSalary" id="minSalary" placeholder="Your Minimum Salary" class="form-control" required="required">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" id="field" name="maxSalary" id="maxSalary" placeholder="Your Maximum Salary" class="form-control" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="cpname" id="field" class="form-control" required="required" placeholder="Contact Person Name">
                                    </div>  <div class="col-md-6">
                                        <label for="cpnum" style="color:#000;">Contact Person Number</label>
                                        <input type="text" name="cpnum" id="field" class="form-control" required="required" placeholder="Contact Person Number" pattern="{0-9}[10]" maxlength="10">
                                    </div></div>
                                     <div class="row form-group">
                            ...
                            <select class="form-control"  name="exp" required="required" id="field">
                                ...
                                <option>Others</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="j_desc" id="field" class="form-control" required="required" placeholder="Job Description" rows="6" cols="50">  1) &#10; 2) &#10; 3) &#10; 4)</textarea>
                                        </div>

                                <div class="col-md-6">
                                        <label for="cpname" style="color:#000;">About Company</label>
                                        <textarea name="about_comp" id="field" class="form-control" required="required" placeholder="About Company" rows="6" cols="50"></textarea>
                                        </div></div>
                                     <div class="row form-group">
		    ...
		    <div id="myDIV" class="col-md-6">-->
				<div class="row form-group">
					 <div id="myDIV" class="col-md-12">
                                ...
                                <input type="text" name="skill" class="form-control" id="myInput" placeholder="Your Skills" onkeyup="showResult(this.value)" style="margin:0;border:none;border-radius:0;width:72%; margin-left: 1%;  padding: 10px;float: left;font-size: 16px;">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="company" class="form-control" required="required" placeholder="Company" id="field">
                            </div>
                            <div class="col-md-6">
                                  <label for="jobTitle" style="color:#000;">Internship Title</label>
                                  <input type="text" name="intTitle" id="field" class="form-control" placeholder="Internship Title" required="required">
                            </div>
                            </div>
                           <div class="row form-group">
                            <div class="col-md-6">
                                <label for="education" style="color:#000;">Highest Qualification</label>
                                <select class="form-control"  name="education" required="required" id="field" placeholder="Highest Qualifications" >
                                            <option value=""></option>
                            ...
                            <select class="form-control" name="exp" required="required" id="field" placeholder="Duration">
                                <option value=""></option>
                                <option></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                <label for="email" style="color:#000;">Email</label>
                                <input type="email" name="email" class="form-control" required="required" id="field" placeholder="Email">
                            </div></div>
                            <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <label for="cpnum" style="color:#000;">Contact Person Number</label>
                                        <input type="text" name="cpnum" id="field" class="form-control" required="required" pattern="{0-9}[10]" maxlength="10" placeholder="Contact Person Number" >
                                    </div></div>
                                    <div class="row form-group">
                                         <div class="col-md-6">
                                        <label for="cpname" style="color:#000;">Company Description</label>
                                        <textarea name="about_comp" id="field" class="form-control" required="required" rows="6" cols="50" placeholder="Company Description" ></textarea>
                                        </div>
                                    <div class="col-md-6">
                                        <label for="idesc" style="color:#000;">Internship Description</label>
                                        <textarea name="j_desc" id="field" class="form-control" required="required" placeholder="Internship Description" rows="6" cols="50"> 1) &#10; 2) &#10; 3) &#10; 4)</textarea>
                                    </div>
				    ...
				    <div class="row form-group">
                        	    <div class="col-md-12">
                                	<label for="mobno" style="color:#000;">Skills</label>
                                            <input type="text" name="interest" class="form-control" id="uInput" placeholder="Skills" onkeyup="showinterestResult(this.value)" style="margin:0;border:none;border-radius:0;width:75%;  padding: 10px;float: left;font-size: 16px;">
