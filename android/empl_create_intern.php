    ...
    class ApiCreateInternship extends Rest{
        ...
        public function createInternship(){
		    ...
		    try{
		        ...
		        $stmt = $this->dbConn->prepare('insert into jobpost (jobTitle, company, email,maxSalary, cpname, cpnum, j_desc, status, exp, education,about_comp,type,agency_id) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)');
