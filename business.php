                   ...
                   <form action="<?=($_SERVER['PHP_SELF'])?>" method="post" class="formJob" style="border: 2px solid #999;padding: 2%;width:90%;margin-left: 5%;" enctype="multipart/form-data" >
                       <p><b style="color:red;">*</b> BUSINESS Information</p>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                               ...
                               <input type="text" name="name"id="field"  class="form-control" placeholder="Enter Your Name" required>
                           </div>
                           <div class="col-md-6">
                               <label for="companyname">Organization/Company / Indiviual Name</label>
                               <input type="text" name="companyName" id="field" class="form-control" placeholder="Your Organization/Company/Indiviual Name" required>
                           </div>
                       </div>
                       <div class="row">
                           <div class="col-md-6">
                               <label for="contactPerson">Designation</label>
                               <input type="text" name="Designation" id="field" class="form-control" placeholder="Your Designation" required>
                           </div>
                           <div class="col-md-6">
                               <label for="emailAddress">Email Address</label>
                               <input type="email" name="email" id="field" class="form-control" placeholder="Enter Your Email Address" required>
                           </div>
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" name="mobno" id="field" pattern="[0-9]{10}" maxlength="10" class="form-control" placeholder="Enter Your Contact Number" required>
                         </div>
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-6">
                             ...
                             <input type="text" id="field" name="Location" id="emailAddress" class="form-control" placeholder="Business Location" required>
                         </div>
                      </div>
                      <div class="row">
                        <div class="col-md-12">
                          <label for="Messsage">Write Us!</label>
                            <textarea rows="3" id="field" style="width:100%;" name="msg" placeholder="Write Us!"></textarea>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
