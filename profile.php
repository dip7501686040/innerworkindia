                   ...
                   <!------------------------------->
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" name="username" class="form-control" placeholder="Enter Username" value=" <?php echo $_SESSION['contactperson']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
...
<?php if($_SESSION['type']=="Agency"){?>
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-last-name" name="website" class="form-control" placeholder="Enter Last Name" value=" <?php echo $_SESSION['website']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-first-name" name="companyname" class="form-control" placeholder="Enter First name" value="<?php echo $_SESSION['companyname']; ?>">
                      </div>
                    </div><?php }
                     ?>
                  </div>
